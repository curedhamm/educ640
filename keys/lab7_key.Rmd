...
ANOVA results indicate a significant interaction between condition and study time, *F*(2, 14) = 17.105, *p* < .001, $\omega^2_p$ = 0.71. The partial omega squared of 0.71 indicates that condition and study time jointly explain about 71% of the difference in vocabulary learning.  
...
omega.F(dfm = 1, dfe = 7,
      Fvalue = 22.78153, n = 48, a = .005)
```

With corrections, our $\alpha_{adj}$ = .05/10 = .005. The difference that time makes from 60 to 180 seconds, differs significantly by 12 points between instructional conditions and explains 76% of the difference between the 60 and 180 second conditions ($t$ = 4.54, $p$ = .002, $\omega^2_p$ = 0.76).
