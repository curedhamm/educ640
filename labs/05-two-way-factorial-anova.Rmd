...
contrasts <- list(
  hyp1 = c(1, 0, -1, -1, 0, 1), #hypothetical contrasts: fill in appropriate numbers
  hyp2 = c(1, -.5, -.5, -1, -.5, -.5) #hypothetical contrasts: fill in numbers
)
...
```{r}
m1 <- lm(vocab ~ inst, vocab5_data) #this is the model you need to run
...
contrasts1 <- list(
  hyp1_1 = c(1, -1, 0), #hypothetical contrast numbers, fill in your own
  hyp2_1 = c(1, 0, -1)  #hypothetical contrast numbers, fill in your own
  )
contrast(means1, contrasts1)Week
