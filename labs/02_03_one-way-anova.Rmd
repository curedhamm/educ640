...
Depending on your needs, you can conduct a number of pairwise comparisons in R. The most common are in the `rstatix` package: Tukey, Games-Howell, and Bonferroni. Each of them can be calculated by inputing the data and the formula; you should select which comparison works for you based on your data. 
