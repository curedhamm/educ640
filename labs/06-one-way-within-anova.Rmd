...
At this point, you should have enough information to check all assumptions except sphericity. For that, we need to run Mauchly's test from the `afex` package which will be included in the output below, in 
